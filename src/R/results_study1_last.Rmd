...
This file reruns our principle study from `results_study1_first.Rmd` utilizing _last in time_ responses. You'll find that the results are very similar to our
principal analyses. They are included as a robustness check.
...
load(file = here(MATCHES_DIR, "dat_plus_matches_study1_last.rda"), verbose = TRUE)
load(file = here(MATCHES_DIR, "outcome_analysis_study1_last.rda"))
```
...
What about within-pair differences? The following table summarizes the differences within pairs.
